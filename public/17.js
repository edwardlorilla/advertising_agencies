...
Component.options.__file = "resources/js/components/invoicestatus/view.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d8fb4740", Component.options)
  } else {
    hotAPI.reload("data-v-d8fb4740", Component.options)
  }
...
var update = __webpack_require__(203)("5de9e7d0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d8fb4740\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./view.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d8fb4740\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./view.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Table_Grid_vue__ = __webpack_require__(355);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            columns: [{
                label: 'Description',
                prop: 'invoice_status_description'
            }],
            data: []
        };
    },
    ...
    beforeRouteEnter: function beforeRouteEnter(to, from, next) {
        axios.get('/api/invoice-status', { params: to.query }).then(function (response) {
            next(function (vm) {
    ...
    [
      _c("grid-view", {
        attrs: {
          columns: _vm.columns,
          data: _vm.data,
          "create-name": "Add Invoice Status",
          "on-delete": "/api/invoice-status",
          "on-edit-name": "edit-invoice-status",
          "on-create-name": "create-invoice-status"
        },
        on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-d8fb4740", module.exports)
  }
}
